    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('bookdetails.addbook') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="price" class="form-control" placeholder="Enter Book Price" value="{{ old('price') }}">
                        @error('price')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" name="stock" class="form-control" placeholder="Enter Stock Number" value="{{ old('stock') }}">
                        @error('stock')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary"><b>Add Book</b></button><br>
